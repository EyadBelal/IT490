...
<p class="projectlogo" align="center" style="font-size: 40px;"> <span style="font-size: 35px;"></span>Welcome to JATE</p>
...
<!--<div class="container text-center">    
    <h3>Popular <span style="color: #c23142;">Move</span> </h3><br>
    <div class="row">
        <div class="col-md-2">
            <div class="thumbnail">
              <a href="image/city dream.jpeg">
                <img src="image/city dream.jpeg" alt="Lights" style="width:100%">
                <div class="caption">
                  <p>City Dream</p>
                </div>
              </a>
          ...
          <div class="col-md-2">
            <div class="thumbnail">
              <a href="image/haven in now.jpeg">
                <img src="image/haven in now.jpeg" alt="Lights" style="width:100%">
                <div class="caption">
                  <p>Haven In Now</p>
                </div>
              </a>
          ...
          <div class="col-md-2">
            <div class="thumbnail">
              <a href="image/iron door.jpeg">
                <img src="image/iron door.jpeg" alt="Lights" style="width:100%">
                <div class="caption">
                  <p>Iron Door</p>
                </div>
              </a>
          ...
          <div class="col-md-2">
            <div class="thumbnail">
              <a href="image/the earth.jpeg">
                <img src="image/the earth.jpeg" alt="Lights" style="width:100%">
                <div class="caption">
                  <p>The Earth</p>
                </div>
              </a>
          ...
          <div class="col-md-2">
            <div class="thumbnail">
              <a href="image/deceived.jpeg">
                <img src="image/deceived.jpeg" alt="Lights" style="width:100%">
                <div class="caption">
                  <p>Deceived</p>
                </div>
              </a>
          ...
          <div class="col-md-2">
            <div class="thumbnail">
              <a href="image/dive end .jpeg">
                <img src="image/dive end .jpeg" alt="Lights" style="width:100%">
                <div class="caption">
                  <p>Dive Hend</p>
                </div>
              </a>
